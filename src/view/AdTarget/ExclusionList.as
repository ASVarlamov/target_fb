...
package view.AdTarget
{
	...
	public class ExclusionList extends AdTargetBase
	{
		...
		private function onNeedRemoveIem(e:Event = null):void
		{
			...
			{
				_data.removeExclusion(_itemList.selectedItem.id);
				data = _data;
			}
		}
		...
		{
			super.data = value;
			_itemList.dataProvider = new ListCollection(_data.exclusions);
